...
const Login = () => {
    ...
    const handlePwdChange = (e) => {
      ...
      useEffect(() => {
        if(email === "" || !email.includes("@gmail.com") || pwd === "" ) {
            setError(false)
      ...
      const handleSubmit = () => {
       ...
       if(email !== userEmail || pwd !== userPwd) {
           setErrorMessage("email error or password error ")
    } else {
        if(typeof window !== 'undefined') {
  ...
  return (
     <main className="mx-2 md:mt-[10%] md:flex md:mx-3 md:items-center">
       <div className="hidden md:block md:w-[50%] md:mt-[16%]">
       ...
       <div className="mt-[20%] md:w-[50%]" >
        <h1 className="text-xl font-bold font-mono capitalize mt-[2%]">welcome back user</h1>
            ...
            <div className="flex justify-between items-center capitalize mt-[2%]">
                <p className="font-semibold">don`t have an account <Link href="./signUp" className="text-green-300 font-bold font-mono text-sm md:text-lg" > sign up</Link></p>
                <Link href="./forgotPassword" className=" text-sm font-bold font-mono md:text-lg">forgot password</Link>
            </div>
            ...
            { error ? (
                        <button className="mt-3 p-2 w-[80%] rounded-lg mx-[10%] text-white capitalize font-semibold bg-green-400 text-lg" onClick={handleSubmit}>
                            Login
                        </button>
                        ) : (
